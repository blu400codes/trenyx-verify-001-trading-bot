...
- Adjudication: 3 failures were OUR harness's fault (trailing-stop tests did not call the
  ...
  Fixed in commit history — the mistakes stay visible. (Earlier in-text times were hand-written estimates and wrong; corrected to commit-anchored times — see ../CORRECTIONS.md.)
